...
public class Game2048 extends AppCompatActivity implements GestureDetector.OnGestureListener {
    ...
    /**
     * @return Devuelve si no hay más movimiento el game over.
     */
    ...
    /**
     * En caso de que sea posible el movimiento, intentará sumar las filas, si no son iguales no lo
     * sumará en caso de que sí lo sea, los sumará y dará el valor.
     */
