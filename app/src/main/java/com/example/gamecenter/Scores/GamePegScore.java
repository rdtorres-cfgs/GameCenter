...
public class GamePegScore extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    String username;
    SQLiteDatabase db;
    DBHelper helper;
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        switch (i) {
            ...
            case 0:
                orderBy = "username";
                Log.d(TAG, "caso 0 segun username");
                helper.mostrarPuntuacionPegUsuario(textViewTodasPuntuacion, db, orderBy);
                break;
            case 1:
                orderBy = "score_2048";
                Log.d(TAG, "caso 1 segun score");
                helper.mostrarPuntuacionPeg(textViewTodasPuntuacion, db, orderBy);
                break;
            case 2:
                orderBy = "time_2048";
